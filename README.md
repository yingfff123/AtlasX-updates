...
| 日期 | 版本 | 内容 |
|------|------|------|
| 2026-09-12 | **0.3.1**（当前） | 路径发现热更：终态耗尽 + 波级隔离，修扫描卡死与 OOM；Docker 热更同步到 worker。[Release](https://github.com/yingfff123/AtlasX-updates/releases/tag/upgrade-0.3.1) · sha256 `0e29e204ef3225ba2ae6c22db0b9af9ce38da459022446052af5ede48f5e08ff` |
