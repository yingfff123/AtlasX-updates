...
| 日期 | 版本 | 内容 |
|------|------|------|
| 2026-09-13 | **0.3.2**（当前） | 路径发现修补：假耗尽 / 浅爬全程 / 进度口径。[Release](https://github.com/yingfff123/AtlasX-updates/releases/tag/upgrade-0.3.2) · sha256 `4fcf6dec11b0250083c617efecd0fdd02857849db000c9fcda64593fa7a9db0b` |
| 2026-09-12 | 0.3.1 | 路径发现热更：终态耗尽 + 波级隔离；瘦快照补 risk_level；Docker worker 同步。[Release](https://github.com/yingfff123/AtlasX-updates/releases/tag/upgrade-0.3.2) · sha256 `c2b0f4e7202062a507f6fdb55edba3e42605a1318963f714486376ed3b94a432` |
