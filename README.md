...
| 最新升级包 | [Releases · upgrade-0.2.8](https://github.com/yingfff123/AtlasX-updates/releases/tag/upgrade-0.2.8) |
...
| 日期 | 版本 | 内容 |
|------|------|------|
| 2026-09-10 | **0.2.8**（当前） | veo 合法 0 命中打空指纹戳，不再误报「0 chunk」；升级自动重启（macOS `kickstart` / Docker compose·旗标）；`requires: 0.2.7.4`，`force_upgrade`。[Release](https://github.com/yingfff123/AtlasX-updates/releases/tag/upgrade-0.2.8) · sha256 `62c5fe67f28e804b6cd404e99192f6e144eaa0e06744e984b369903d21270625` |
