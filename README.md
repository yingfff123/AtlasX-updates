...
| 最新升级包 | [Releases · upgrade-0.3.1](https://github.com/yingfff123/AtlasX-updates/releases/tag/upgrade-0.3.1) |
...
| 日期 | 版本 | 内容 |
|------|------|------|
| 2026-09-12 | **0.3.1**（当前） | 路径发现热更：终态耗尽 + 波级隔离；瘦快照补 risk_level；Docker worker 同步。[Release](https://github.com/yingfff123/AtlasX-updates/releases/tag/upgrade-0.3.1) · sha256 `c2b0f4e7202062a507f6fdb55edba3e42605a1318963f714486376ed3b94a432` |
