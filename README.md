...
| 日期 | 版本 | 内容 |
|------|------|------|
| 2026-09-12 | **0.2.9**（当前） | CE / Pro 均可升级；栈手测清单扩充。[Release](https://github.com/yingfff123/AtlasX-updates/releases/tag/upgrade-0.2.9) · sha256 `a35d03de8e183b904732b3f00b67aed98e0130ed206bf9e47715bdbc080fd07b` |
